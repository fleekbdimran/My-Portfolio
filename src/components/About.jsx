        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="mt-2 text-3xl leading-8 font-extrabold tracking-tight text-gray-900 sm:text-4xl">
              Hi, I'm Imran Uddin Chowdhury
            </p>
            <p className="mt-4 max-w-2xl text-xl text-gray-500 lg:mx-auto">
              I am a Full-Stack Developer specializing in web development,
              WordPress, and the MERN stack. I craft dynamic, responsive, and
              user-friendly web solutions that combine modern technology with
            ...
            <div className="grid grid-cols-1 gap-12 lg:grid-cols-2">
              <div>
                ...
                <p className="mt-4 text-lg text-gray-600">
                  ...
                  in the MERN stack (MongoDB, Express.js, React, Node.js), as
                  well as Laravel and MySQL.
                </p>
                <img
                  src={MernStack}
                  alt=""
              ...
              <div className="border border-red-200 rounded-lg md:p-7 py-7  flex flex-col gap-8 items-center shadow-lg shadow-red-300">
                ...
                <div className="flex items-center justify-center flex-wrap gap-3">
                  ...
                  <div className="border border-red-300 flex items-center gap-1 w-max px-2 py-1 rounded-lg shadow-md shadow-red-300">
                    <img src={LaravelIcon} alt="Laravel" className="w-9" />
                    <span className="font-semibold">Laravel</span>
                  </div>
                  <div className="border border-red-300 flex items-center gap-1 w-max px-2 py-1 rounded-lg shadow-md shadow-red-300">
                    <img src={MySQLIcon} alt="MySQL" className="w-9" />
