      ...
      <div className='max-w-7xl mx-auto'>
        <div className='flex flex-col md:flex-row items-center lg:h-[90vh] justify-between' >
            <div className='md:w-1/2 mb-8 md:mb-0 flex flex-col space-y-4 px-6 lg:px-0 lg:mt-0 mt-10'>
               <h1 className='lg:text-7xl text-4xl font-bold lg:leading-snug'>Hi There, <br />I'm Imran <span className='text-red-500'>Uddin Chowdhury</span></h1>
               <p className='md:text-2xl text-xl mb-4'>Full Stack & Mern Stack Developer</p>
               <p className='mb-4'>Hello! I'm a dedicated web developer with a deep passion for crafting seamless digital experiences. My expertise spans across modern technologies like React, Node.js, Express.js, Laravel, MySQL, and MongoDB. I specialize in building responsive, user-centric websites and applications that not only look great but also solve real-world problems effectively.</p>
            ...
            <div className='md:w-1/2 relative flex justify-center items-end'>
                 <img src={joy} alt="" className='lg:h-[90vh] h-96' />
